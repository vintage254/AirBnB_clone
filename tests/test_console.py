...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_helpquit(self):
        comp = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(comp, output.getvalue().strip())

    def test_helpcreate(self):
        comp = ("Usage: create <class>\n        "
    ...
    def test_helpEOF(self):
        comp = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(comp, output.getvalue().strip())

    def test_helpshow(self):
        comp = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_helpdestroy(self):
        comp = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
    ...
    def test_helpall(self):
        comp = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_helpcount(self):
        comp = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_helpupdate(self):
        comp = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_help(self):
        comp = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_id_dotnotation(self):
        comp = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_invalid_id_dotnotation(self):
        comp = "** no instance found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_name_spacenotation(self):
